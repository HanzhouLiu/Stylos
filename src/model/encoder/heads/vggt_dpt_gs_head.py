...
class VGGT_DPT_GS_Head(DPTHead):
    def __init__(self, 
        ...
        super().__init__(dim_in, patch_size, output_dim, activation, conf_activation, features, out_channels, intermediate_layer_idx, pos_embed, feature_only, down_ratio, resize_method)
