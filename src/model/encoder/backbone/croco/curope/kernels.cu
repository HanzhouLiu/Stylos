...
void rope_2d_cuda( torch::Tensor tokens, const torch::Tensor pos, const float base, const float fwd ) 
{
    ...
    AT_DISPATCH_FLOATING_TYPES_AND_HALF(tokens.scalar_type(), "rope_2d_cuda", ([&] {  // change the tokens.type() to tokens.scalar_type(), refer to https://github.com/naver/croco/issues/43
