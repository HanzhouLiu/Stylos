...
from src.model.encoder.stylos import EncoderStylos, EncoderStylosCfg, OpacityMappingCfg
...
class Stylos(nn.Module, huggingface_hub.PyTorchModelHubMixin):
    def __init__(
        self,
        encoder_cfg: EncoderStylosCfg,
        decoder_cfg: DecoderSplattingCUDACfg,
    ):  
        super(Stylos, self).__init__()
        self.encoder_cfg = encoder_cfg
        self.decoder_cfg = decoder_cfg
        self.build_encoder(encoder_cfg)
        self.build_decoder(decoder_cfg)
        # self.load_pretrained_backbone("/workspace/Code/StyleStylos/checkpoints/model.safetensors",freeze=True)
    ...
    def convert_encoder_config(self, encoder_cfg: EncoderStylosCfg) -> EncoderStylosCfg:
