...
class DatasetCo3d(Dataset):
    ...
    def getitem(self, index: int, num_context_views: int, patchsize: tuple) -> dict:
        ...
        # ==== New: randomly select style image ====
        ...
        H, W = example["context"]["image"].shape[2:]
        style_image = v2.Resize((H, W))(style_image)
